...
/**
 * Provides a block that lists makerspace facilitator links.
 *
 * @Block(
 *   id = "makerspace_facilitator_links_block",
 *   admin_label = @Translation("Facilitator Actions"),
 *   category = @Translation("Makerspace")
 * )
 */
class FacilitatorLinksBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * FacilitatorLinksBlock constructor.
   */
  ...
  public function build(): array {
    ...
    $groups = $this->linkManager->getGroupedLinks($account, $this->currentUser, 'facilitator');
    if (empty($groups)) {
      return [];
    }
